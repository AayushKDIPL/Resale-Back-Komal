...
const projectController = {
  getProducts: async (req, res) => {
    try {
      ...
      const totalProducts = await project.find({}).count();
  ...
  getProduct: async (req, res) => {
    try {
      const data = await project.findById(req.params._id);
  ...
  addProduct: async (req, res) => {
    try {
        ...
        const products = await project.create({
  ...
  deleteProduct: async (req, res) => {
    try {
      let product = await project.findById(req.params._id);
